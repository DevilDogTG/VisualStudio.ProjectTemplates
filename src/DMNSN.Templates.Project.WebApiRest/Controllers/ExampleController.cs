using DMNSN.Templates.Project.WebApiRest.Abstracts;
using DMNSN.Templates.Project.WebApiRest.Settings;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Extensions.Options;

namespace DMNSN.Templates.Project.WebApiRest.Controllers;
